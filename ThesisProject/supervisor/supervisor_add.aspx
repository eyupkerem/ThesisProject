<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="supervisor_add.aspx.cs" Inherits="ThesisProject.supervisor.supervisor_add" %>
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <form id="form2" runat="server">
                    <h3>Supervisor Add</h3>
                    <div class="addSupervisor">
                      <label for="Cosupervisor Name"></label>
                      <asp:TextBox runat="server" ID="txtSupervisorName" CssClass="form-control" placeHolder="Supervisor Name" required />                       
