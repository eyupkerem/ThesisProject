<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="languages_add.aspx.cs" Inherits="ThesisProject.languages.language_add" %>
                   ...
                   <form id="form1" runat="server">
                        <h3>Add Language</h3>
                          <div class="addLanguage"> 
                           <label for="Langugae"></label>
                              <asp:TextBox runat="server" ID="txtLanguage" CssClass="form-control" placeHolder="Language" />                       
                           </div>
                            <asp:Button Text="Save" ID="btnSave" runat="server" CssClass="btn btn-success" OnClick="btnSave_Click" />
                            <a href="/language/language_list.aspx" class="btn btn-danger">Cancel</a>
                   </form>
            </div>    
        </div>
