<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_cosupervisor_list.aspx.cs" Inherits="ThesisProject.userViews.user_cosupervisor_list" %>
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                <form id="form2" runat="server">
                    <h2 class="table-title">Cosupervisor List</h2>
                  <table class="table table-bordered table-hover">
                      <h1 class="userPageTitle">Cosupervisor List</h1>
        <thead>
           <tr>
             <th>Name</th> 
             <th>Surname</th> 
