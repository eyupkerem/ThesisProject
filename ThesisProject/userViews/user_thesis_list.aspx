<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_thesis_list.aspx.cs" Inherits="ThesisProject.userViews.user_thesis_list" %>
              ...
              <asp:Repeater runat="server" ID="thesisList">
                  <ItemTemplate>
                    <tr>
                      ...
                      <td><%# Eval("PAGENUM") %></td>
                      <td>
                          <asp:HyperLink NavigateUrl='<%# "/thesis/thesis_details.aspx?id=" + Eval("THESIS_ID") %>' runat="server" CssClass="btn btn-primary">Click here to more details</asp:HyperLink>
